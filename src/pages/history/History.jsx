    ...
    <div className="mt-[8px] rounded-lg md:mt-10 mx-auto flex max-w-screen-lg flex-col gap-8 min-h-[840px] min-w-full bg-white shadow-2xl">
      <div className="mx-3 mt-16 mb-6 lg:mx-4">
        <div className="grid gap-4">
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <input
                ...
                placeholder="History text..."
                  className=" w-[320px] ml-1 md:w-52 h-10 px-4 py-2 border-2 border-[#dee2e6] rounded-lg focus:outline-none focus:border-blue-400 placeholder-gray-600 md:mt-0 md:ml-5"
                {...register("text")}
              />
          ...
          <div className="ml-1 md:w-[50rem] grid gap-4 md:mt-5 md:ml-5 max-h-[670px] overflow-y-auto mt-5">
            {data && data.length > 0 &&
              data.map((item) => (
                  ...
                  {editingItemId === item.id ? (
                    <div className="">
                      <textarea
                        ...
                        style={{ resize: "none" }}
                        className="w-full mt-1 h-full md:w-[45rem] md:h-[24rem] border border-black rounded-md px-4 md:ml-0 md:mt-0 text-gray-600 p-2"
                      ></textarea>
