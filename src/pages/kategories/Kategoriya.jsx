          ...
          <div className="flex flex-wrap gap-4 md:block">
            <form className="md:block" onSubmit={handleSubmit(onSubmit)}>
              <div className="items-center md:flex">
                <input
                  ...
                  className=" w-[320px] md:ml-5 h-10 rounded-lg border-2 md:w-52  border-[#dee2e6] px-4 py-2 placeholder-gray-600 focus:border-blue-400 focus:outline-none"
                  {...register("name")}
                />
                <button
                  type="submit"
                  className=" w-[320px] mt-3 md:ml-5 flex h-10 md:w-52 md:mt-0 rounded-lg border-2 border-[#dee2e6] px-4 py-2 text-center text-gray-600 hover:border-blue-400 hover:bg-blue-400 hover:text-white"
                >
            ...
            <div className="md:ml-5 grid max-h-[670px] w-[50rem] gap-4 overflow-y-auto">
              {data.map((category) => (
                <>
                <div
                  className="w-[320px] md:flex md:mt-5 md:w-full items-center justify-evenly border-2 border-[#dee2e6] p-2"
                  key={category.id}
                >
                    ...
                    >
                      <div className="mt-2 flex gap-11 md:flex">
                        ...
                        <input
                          ...
                          className=" w-[320px] mt-3 md:ml-0 h-10 md:w-52 md:mt-0 rounded-lg border-2 border-[#dee2e6] px-4 py-2 placeholder-gray-600 focus:border-blue-400 focus:outline-none"
                          {...register("slug")}
                        />
                        <button
                          type="submit"
                          className=" w-32 flex items-center justify-evenly md:flex h-10 md:w-44 rounded-lg border-2 border-gray-400 px-4 py-2 text-black"
                        >
