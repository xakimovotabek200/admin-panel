        ...
        <div className="grid gap-4">
            ...
            <form className="" onSubmit={handleSubmit(onSubmit)}>
              <div className="items-center md:flex">
                ...
                <input
                  ...
                  {...register("name")}
                />
                <button type="submit" className="w-[320px] ml-1 mt-3 md:w-52 h-10 px-4 py-2 flex text-center border-2 border-[#dee2e6] text-gray-600 rounded-lg md:mt-0 md:ml-5 hover:bg-blue-400 hover:border-blue-400 hover:text-white">
          ...
          <div>
            <div className="ml-1 md:w-[50rem] grid gap-4 md:mt-0 md:ml-5 max-h-[670px] overflow-y-auto mt-5">
              {data.map((item) => (
                <>
                  <div className="w-[320px] md:flex md:w-full items-center justify-evenly md:justify-between border-2 border-[#dee2e6] p-2" key={item.id}>
                    ...
                    <form className="kategoriya_child_dates" onSubmit={handleSubmit(onEdit)}>
                      <div className="mt-2 flex gap-11 md:flex ">
                        <input
                          ...
                          className="w-32 md:flex h-10 md:w-52 items-center justify-evenly rounded-lg border-2 border-[#dee2e6] px-4 py-2 text-gray-600 focus:outline-none"
                          {...register("name")}
                        />
                        <button type="submit" className="w-32 flex items-center justify-evenly md:w-52 h-10 border-2 border-[#dee2e6] text-gray-600 rounded-lg text-center ml-5">
